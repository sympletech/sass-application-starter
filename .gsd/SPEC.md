...
## Success Criteria
- [ ] Navigation menu links to Home, About, Pricing (anchor), and Login/Signup.
- [ ] Home page includes Hero, Features, and Pricing sections.
- [ ] Legal page contains readable Privacy Policy and Terms of Service boilerplate.
- [ ] About page displays a professional layout with mission/vision statements.
- [ ] Footer includes site navigation, social placeholders, and legal links.
- [ ] Mobile responsive layout for all new public pages.
